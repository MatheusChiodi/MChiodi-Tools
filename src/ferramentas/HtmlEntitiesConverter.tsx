...
export function HtmlEntitiesConverter() {
  ...
  const converter = () => {
    try {
      const res =
        modo === "encode" ? encodeHTML(input) : decodeHTML(input);
      setResultado(res);
    } catch {
    ...
    <main className="mx-auto max-w-4xl px-4">
      ...
      >
        <h1 className="text-4xl font-extrabold text-neutral-50 md:text-6xl">
          HTML <span className="text-blue-400">Entities</span>
        </h1>
        <p className="text-base text-neutral-400 md:text-lg">
          Codifique ou decodifique entidades HTML de forma simples e rápida.
        </p>
